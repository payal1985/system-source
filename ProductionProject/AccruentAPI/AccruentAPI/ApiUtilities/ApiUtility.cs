...
using AccruentAPI.Repositories;
...
namespace AccruentAPI.ApiUtilities
{
    public class ApiUtility
    {
        ...
        public List<AccruentApi> GetRequestByAssignGroup(string requestType, string assignment_group)
        {
                ...
                if (assignment_group != null)
                {
                    ...
                    if (response.Content != null && response.IsSuccessStatusCode)
                    {
                        ...
                        foreach (JProperty p in o.Properties())
                        {
                            ...
                            accruentApisList = value.ToObject<List<AccruentApi>>();
