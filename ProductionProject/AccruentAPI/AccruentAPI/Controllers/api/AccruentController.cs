using AccruentAPI.ApiUtilities;
...
namespace AccruentAPI.Controllers.api
{
    public class AccruentController : ApiController
    {
        private IAccruentRepository accruentRepository { get; set; }
        ApiUtility apiUtility;
        AppConfigs appConfigs;
        Logger logger;
        EmailNotificationUtility emailNotificationUtility = null;

        public AccruentController()
        {
