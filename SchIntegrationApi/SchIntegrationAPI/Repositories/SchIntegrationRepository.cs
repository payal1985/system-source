...
{
    public class SchIntegrationRepository : ISchIntegrationRepository
    {
        ...
        public SchIntegrationRepository(string connectionString, EmailNotificationUtility emailNotificationUtility, IConnectionUtility connectionUtility = null)
        {
        ...
        public bool AddRequestAsync(List<SchApi> accruentApisList)
        {
            bool result = false;
            ...
            try
            {
                foreach (var data in accruentApisList)
                {
                    ...
                    string req_subject = data.number + " - " + (data.URoomModel != null ? data.URoomModel.ualtfullname : "") + " " + data.description.Split('.')[0];

                    string description = "Building:" + data.u_building + ",\n" + "Floor:" + (data.UFloorModel != null ? data.UFloorModel.ualtfullname : "") + ",\n" + "Room:" + (data.URoomModel != null ? data.URoomModel.ualtfullname : "") +
                    ",\n" + "Location:" + data.x_ctv_sc_location_description + ",\n" + "Description:" + data.description;
                    ...
                    {
                        parameters.Add(ConnectionUtility.CreateParameter("@eu_name", 50, "", DbType.String));
                        parameters.Add(ConnectionUtility.CreateParameter("@eu_note", 50, "", DbType.String));
                        parameters.Add(ConnectionUtility.CreateParameter("@eu_email", 50, "", DbType.String));
                    }
                    ...
                    parameters.Add(ConnectionUtility.CreateParameter("@eu_phone", 200, ((data.CtvScCallerModel != null && !string.IsNullOrEmpty(data.CtvScCallerModel.phone)) ? data.CtvScCallerModel.phone : ""), DbType.String)); 
                    ...
                    parameters.Add(ConnectionUtility.CreateParameter("@floor_u_alt_full_name", 50, ((data.UFloorModel != null && !string.IsNullOrEmpty(data.UFloorModel.ualtfullname)) ? data.UFloorModel.ualtfullname : ""), DbType.String));
                    parameters.Add(ConnectionUtility.CreateParameter("@room_u_alt_full_name", 50, ((data.URoomModel != null && !string.IsNullOrEmpty(data.URoomModel.ualtfullname)) ? data.URoomModel.ualtfullname : ""), DbType.String));
