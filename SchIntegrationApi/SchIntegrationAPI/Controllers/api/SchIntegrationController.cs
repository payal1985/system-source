...
namespace SchIntegrationAPI.Controllers.api
{
    ...
    {
        private ISchIntegrationRepository schIntegrationRepository { get; set; }
        ...
        public SchIntegrationController()
        {
            ...
            schIntegrationRepository = new SchIntegrationRepository(appConfigs.ConnectionString, emailNotificationUtility);
        ...
        public IHttpActionResult Get(string assignment_group)
        {
            ...
            try
            {
                ...
                else
                {
                   ...
                   result = schIntegrationRepository.AddRequestAsync(accruentApisList);
