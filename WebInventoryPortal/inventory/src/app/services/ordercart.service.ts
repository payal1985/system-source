...
export class OrderCartService {
  ...
  public inventoryList = new BehaviorSubject<ordercart[]>([]);
  ...
  addtoCart(addedItem : ordercart,qty: number){
    //debugger;
    ...
    let i:any;
    if(this.items)
        i = this.items.findIndex(_item => _item.inventory_id === addedItem.inventory_id && _item.inv_item_id === addedItem.inv_item_id && _item.client_id === addedItem.client_id);
