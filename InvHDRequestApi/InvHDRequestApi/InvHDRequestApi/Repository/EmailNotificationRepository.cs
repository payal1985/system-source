...
namespace InvHDRequestApi.Repository
{
    public class EmailNotificationRepository: IEmailNotificationRepository
    {
        ...
        public void SendGenericEmail(string body, string name, string ccemail, string clientname,string requesttype)
        {
            try
            {
                var mail = new MailMessage();
                ...
                mail.From = new MailAddress(Configuration.GetValue<string>("EmailConfigs:FromMail"), clientname + ' ' + Configuration.GetValue<string>("EmailConfigs:DisplayName"));
                mail.Subject = $"{clientname} {requesttype} {Configuration.GetValue<string>("EmailConfigs:GenericSubject")} {name}";
                mail.Body = body;
                mail.IsBodyHtml = true;
                SmtpClient.Send(mail);
            }
        ...
        //public void SendWarrantyEmail(string body, string name, string ccemail, string clientname)
        //{
        //    try
        //    {
        //        var mail = new MailMessage();
        ...
        //        mail.From = new MailAddress(Configuration.GetValue<string>("EmailConfigs:FromMail"), clientname + ' ' + Configuration.GetValue<string>("EmailConfigs:DisplayName"));
        //        mail.Subject = $"{clientname} {Configuration.GetValue<string>("EmailConfigs:WarrantySubject")} {name}";
        //        mail.Body = body;
        //        mail.IsBodyHtml = true;
        //        SmtpClient.Send(mail);
        //    }
        ...
        //}
        //public void SendMaintenanceEmail(string body, string name, string ccemail, string clientname)
        //{
        //    try
        //    {
        //        var mail = new MailMessage();
        ...
        //        mail.From = new MailAddress(Configuration.GetValue<string>("EmailConfigs:FromMail"), clientname + ' ' + Configuration.GetValue<string>("EmailConfigs:DisplayName"));
        //        mail.Subject = $"{clientname} {Configuration.GetValue<string>("EmailConfigs:MaintenanceSubject")} {name}";
        //        mail.Body = body;
        //        mail.IsBodyHtml = true;
        //        SmtpClient.Send(mail);
        //    }
        ...
        //public void SendCleaningEmail(string body, string name, string ccemail, string clientname)
        //{
        //    try
        //    {
        //        var mail = new MailMessage();
        ...
        //        mail.From = new MailAddress(Configuration.GetValue<string>("EmailConfigs:FromMail"), clientname + ' ' + Configuration.GetValue<string>("EmailConfigs:DisplayName"));
        //        mail.Subject = $"{clientname} {Configuration.GetValue<string>("EmailConfigs:CleaningSubject")} {name}";
        //        mail.Body = body;
        //        mail.IsBodyHtml = true;
        //        SmtpClient.Send(mail);
        //    }
